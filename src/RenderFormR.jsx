...
var allFormComp = ['InputEle', 'CheckRadio', 'SetMobileCont', 'GetMsgCode', 'DateInputEle','Linkage']
var RenderFormR = React.createClass({
  ...
  goSub: function(e) {
    ...
    var obj = {name:'location',value:this.state.linkageData}
    postData.push(obj)
  ...
  getComponents:function(newSelFields,i,n){
    ...
    if(newSelFields.type=="input"||newSelFields.type=="select"||newSelFields.type=="textarea"||newSelFields.type=="password"||newSelFields.type=="hidden"){
        ...
        rendHtml.push(
          <InputEle 
            key={i} 
            value={newSelFields.defaultValue}  
            ispwd={x} 
            placeholder={newSelFields.placeholder}
            type={newSelFields.type} 
            ref={newSelFields.field} 
            title={n+newSelFields.name} 
            name={newSelFields.field} 
            optionsArr={newSelFields.optionsArr} />
        );
        ...
        <CheckRadio 
          key={i} 
          getTitle={newSelFields.getTitle?newSelFields.getTitle:false} 
          inline={newSelFields.inline} 
          selLen={newSelFields.count||1} 
          value={newSelFields.defaultValue} 
          ref={newSelFields.field}  
          optionsArr={newArr}  
          type={newSelFields.type} 
        ...
        rendHtml.push(
          <SelUpImg 
            key={i} 
            isSetText={newSelFields.isSetText?newSelFields.isSetText:false} 
            selLen={newSelFields.count}  
            value={newSelFields.defaultValue} 
            ref={newSelFields.field} 
            title={n+newSelFields.name}  
            name={newSelFields.field} />
        ...
        rendHtml.push(
          <SelTags 
            key={i} 
            tagsArr={newSelFields.defaultValue?newSelFields.defaultValue:[]} 
            selLen={newSelFields.count} 
            source={newSelFields.source}  
            title={newSelFields.name} 
            name={newSelFields.field} />
        );
      }else if(newSelFields.type == 'linkage'){
        ...
        rendHtml.push(
          <Linkage
            ...
            name={newSelFields.field}
            title={newSelFields.name}
            item={newSelFields.item}
            handlePostData={this.handleLinkage}
            value={this.state.linkageData}
            />
          )
      }
