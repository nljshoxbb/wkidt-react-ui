...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var FormDocs = __webpack_require__(161)["default"];
	
	ReactDOM.render(React.createElement(FormDocs, null), document.getElementById('wrap'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormCtrl = __webpack_require__(165);
	    ...
	    _createClass(Wrap, [{
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                'div',
	                { className: 'main ', style: { backgroundColor: "#fff", margin: "50px", padding: "50px", border: "1px solid #eee" } },
	                _react2["default"].createElement(_FormCtrl2["default"], { label: '\u59D3\u540D' }),
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_FormCtrl2["default"], { label: '\u5BC6\u7801' }),
	                    _react2["default"].createElement(_FormCtrl2["default"], null),
	                    _react2["default"].createElement(_FormCtrl2["default"], null)
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _public_tools = __webpack_require__(163);
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          'form',
	          { action: '' },
	          this.renderChildren(_react.Children.toArray(children))
	        )
	      );
	    }
	  }]);
	...
	Form.childContextTypes = {
	  getFieldValue: _react2["default"].PropTypes.func,
	  setFieldValue: _react2["default"].PropTypes.func,
	  bindField: _react2["default"].PropTypes.func,
	  unbindField: _react2["default"].PropTypes.func
	};
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.getFieldValue = function () {
	    ...
	    if (typeof field === "string") {
	      if (data[field]) {
	        ...
	        _public_tools2["default"].log(_index.lang.form.noField);
	      }
	    } else {
	      return data;
	    }
	  ...
	  this.setFieldValue = function (field, value) {
	    ...
	    if ((typeof field === 'undefined' ? 'undefined' : _typeof(field)) === "object") {
	      _this2.setState(field);
	      return;
	    }
	    if (field && value && data[field]) {
	      data[field] = value;
	  ...
	  this.bindField = function (name, value) {
	    if (name && value) {
	      ...
	      _public_tools2["default"].log(_index.lang.form.bindFieldArgErr);
	    }
	  };
	  ...
	  this.unbindField = function (name) {
	    ...
	    if (data[field]) {
	      ...
	      _public_tools2["default"].log(_index.lang.form.noUnbindField);
	    }
	  };
	  ...
	  _createClass(FormCtrl, [{
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement('div', { className: 'form-comp-wrap' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var enhance = function enhance(ComponsedComponent) {
	  var FormItem = function (_Component) {
	    ...
	    _createClass(FormItem, [{
	      ...
	      value: function render() {
	        ...
	        return _react2["default"].createElement(ComponsedComponent, this.props);
	      }
	    }]);
	...
	/*const regComp=(ComposedComponent, types = [], options = {})=>{
